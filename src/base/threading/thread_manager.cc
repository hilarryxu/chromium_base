...
{
	StdClosure closure = base::Bind(&ThreadManager::RunRepeatedly, task, delay, times);
...
{
	StdClosure closure = base::Bind(&ThreadManager::RunRepeatedly2, thread_id, task, delay, times);
